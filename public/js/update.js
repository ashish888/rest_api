...
var update_api = {
		...
		$.getJSON("http://localhost/rest_api/product/read_one.php?id=" + id, function(data){
			...
			$.getJSON("http://localhost/rest_api/category/read.php", function(data){
				...
				update_product_html+="<div id='read-products' class='btn btn-primary pull-right m-b-15px read-products-button'>";
					update_product_html+="<i class='fa fa-file-text' aria-hidden='true'></i> Read Products";
						...
						update_product_html+="<tr>";
							...
							update_product_html+="<td>";
								update_product_html+="<button type='submit' class='btn btn-info'>";
									update_product_html+="<i class='fa fa-pencil-square' aria-hidden='true'></i> Update Product";
	...
	update: function(){
		// get form data
		var form_data=$("#update-product-form").serializeObject();
